...
- [Optimal Control of a Wave Energy Converter via Recurrent Reinforcement Learning](paper/Optimal_Control_of_a_Wave_Energy_Converter_via_Recurrent_Reinforcement_Learning.pdf)

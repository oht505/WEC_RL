function instantaneous_values = delayed_inst_f(t,eta,window_size,filter_size,delay_factor)
...
for ii = window_size+1:length(t)
        ...
        mag(ii) = temp_mag(round(window_size*delay_factor));
        phase(ii) = temp_phase(round(window_size*delay_factor));
end
